      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Text(
              '''
【前言】欢迎使用“小蜜蜂管家端”（包括小蜜蜂管家端网站、App、小程序及其他移动应用程序，以下统称“小蜜蜂管家端”）提供的产品和服务。深圳市凯达来科技有限公司（注册地址：深圳市龙岗区横岗街道沙荷路40-11号）及其关联公司作为小蜜蜂管家端运营者（或简称“我们”）深知个人信息对使用我们的产品和服务（以下统称“小蜜蜂管家端服务”）之用户（以下统称“用户”或“您”）的重要性，我们一向庄严承诺保护您的个人信息及隐私安全。您在使用小蜜蜂管家端服务时，我们可能会收集和使用您的相关个人信息。我们希望通过《小蜜蜂管家端隐私政策》（以下简称“本政策”）向您说明我们在收集和使用您相关个人信息时对应的处理规则，以及我们为您提供的访问、更正、删除和保护这些个人信息的方式，以便更好的保障您的权益。
本政策适用于小蜜蜂管家端提供的所有产品和服务，如与《小蜜蜂管家端用户服务协议》条款之约定存在冲突的，以本政策为准。
需要特别说明的是，本政策不适用于其他第三方向您提供的服务，第三方向您提供的服务适用其向您另行说明的隐私政策。
 
【特别提示】请您在使用小蜜蜂管家端服务前，仔细阅读（未成年人请在监护人陪同下阅读）并了解本政策（特别是加粗或下划线标注的内容），以做出适当选择。一旦您同意或在我们更新本政策后继续使用我们的产品或服务，即意味着您同意我们按照本政策处理您的相关个人信息。
 
...
 
一、我们如何收集和使用您的个人信息
我们收集您的个人信息主要是为了您能够更容易和更满意地使用小蜜蜂管家端服务。小蜜蜂管家端的目标是向所有的互联网用户提供安全、舒适的购物体验。而这些信息有助于我们实现这一目标。
 
（一）我们将通过以下途径收集和获得您的个人信息：                            
1、您提供的信息。 例如：
（1）您在注册小蜜蜂管家端账号或使用小蜜蜂管家端服务时，向我们提供的信息；
若您提供的信息中含有其他用户的个人信息，在向我们提供这些个人信息之前，您需确保您已经取得合法的授权。若涉及儿童个人信息的，您需在提供前取得该儿童监护人的同意。
（2）您通过小蜜蜂管家端服务向第三方提供的共享信息，以及您使用小蜜蜂管家端服务时所存储的信息。
请注意，如您在小蜜蜂管家端服务中其他用户可见的公开区域内上传或发布的信息中、您对其他人上传或发布的信息作出的回应中公开您的信息，该等信息可能会被他人收集并加以使用。当您发现他人不正当地收集或使用您的信息时，可通过本政策“如何联系我们”章节所列的反馈渠道联系我们。
2、第三方共享的您的信息。亦即第三方使用小蜜蜂管家端服务时所提供有关您的共享信息。
3、我们获取的您的信息。您在使用小蜜蜂管家端服务时，我们经您授权后收集、汇总、记录的信息，例如日志信息、位置信息、设备信息。
 
（二）我们会出于以下目的，收集和使用您以下类型的个人信息：
1、帮助您完成注册/登录
为便于我们为您提供持续稳定的服务并保障您使用小蜜蜂管家端服务的安全性，我们需要您提供您的手机号码进行注册，并创建您的用户名和密码。如果您仅需使用浏览、搜索等基本功能，您不需要创建账号及提供上述信息。
如您选择以非小蜜蜂管家端账户的第三方账户登录小蜜蜂管家端的，我们可能会根据您的授权从第三方处获取您的第三方账户信息，并与您的小蜜蜂管家端账户进行绑定，使您可通过第三方账户直接登录、使用小蜜蜂管家端服务。
在注册/登录过程中，如果您提供以下额外信息，将有助于我们给您提供个性化的商品推荐和更优的购物体验：您的昵称、性别、出生日期、头像以及您的实名认证等相关信息。但如果您不提供这些信息，并不会影响您使用小蜜蜂管家端服务的基本功能。
...
   设备信息：我们会根据您在软件安装及使用中的具体操作，接收并记录您所使用的设备相关信息。例如：设备型号、操作系统版本、MAC地址、设备设置、设备标识符（IMEI/Android ID/IDFA/OpenUDID/GUID/SIM 卡IMSI 信息）、移动应用列表等软硬件及设备环境信息、设备所在位置相关信息（包括IP 地址、GPS位置以及WLAN接入点、蓝牙和基站等传感器信息）和设备权限信息（包括存储权限），以确保设备操作环境的安全以及提供小蜜蜂管家端服务所必需，防止恶意程序和反作弊。
...
您在小蜜蜂管家端的使用过程中，将可能包含您或者其他人的身份信息、联络信息，这些都属于敏感信息，请您谨慎向他人展示或对外提供。我们也将会在展示信息时，在保证信息可用性的基础上尽量做去标识化处理（如对业主身份申请人的手机号进行脱敏处理）。
4、保障您的使用安全
为提高您使用小蜜蜂管家端服务的安全性，更好地预防钓鱼网站、计算机病毒等安全风险，保护您或其他用户或公众的人身财产安全，更准确地识别违反法律法规或小蜜蜂管家端相关协议规则的情况，我们可能整合您的个人信息、交易信息、设备信息、网络日志及其他第三方依法共享的信息来综合判断您账户及交易风险、进行身份验证、检测及防范安全事件，并依法采取必要的记录、审计、分析、处置措施。
5、为您提供其他扩展服务
为向您提供更符合您需求的产品及/或服务，提升您使用小蜜蜂管家端的体验，我们在向您提供以下扩展服务时可能会基于您的授权收集和使用您的个人信息：
...
您理解并同意，实现上述扩展服务需要您通过开启您设备中相应权限的方式授权我们访问您的相机、相册、日历或获取您的位置信息。如您不提供该授权，不影响您对小蜜蜂管家端服务基本功能的使用。当您需要取消授权时，您可以关闭您设备中的相应权限，具体方法请参考您的设备说明书或联系您设备的服务商或生产商。但是，您关闭权限的决定不会影响此前基于您的授权所进行的信息收集及使用。
12、其他目的和用途
...
我们可能会从关联方、第三方合作伙伴获取您授权共享的相关信息。例如，当您通过第三方合作伙伴网站及其移动应用软件等下单时，您向其提供的订单信息可能会转交给我们，以便我们处理您的订单并保证服务的顺利完成；本条款前述您通过第三方账户登录小蜜蜂管家端时，我们将根据您的授权从第三方合作伙伴获取您授权共享的相关信息（如用户名、头像、昵称，具体以您的授权内容为准），并将您的第三方账户与您的小蜜蜂管家端账户绑定，使您可以通过第三方账户直接登录小蜜蜂管家端。
...
7、根据您的要求签订和履行合同所必需的；
8、维护小蜜蜂管家端所提供的产品或服务的安全稳定运行所必需的，例如发现、处置产品或服务的故障；
9、开展合法的新闻报道所必需的；
...
2、分析您使用我们服务的情况。我们可利用Cookies或同类技术来了解您使用小蜜蜂管家端服务的什么功能、或哪些产品/服务最受欢迎；
3、广告优化。Cookies或同类技术有助于我们根据您的信息，向您提供与您相关的广告而非进行普遍的广告投放。
我们为上述目的使用Cookies或同类技术的同时，可能将通过Cookies或同类技术收集的非个人身份信息汇总提供给广告商或其他合作伙伴，用于分析您和其他用户如何使用小蜜蜂管家端服务并用于广告服务。
您可根据自己的偏好管理或删除、退订 Cookies或同类技术。您通常可根据自己的需要来修改浏览器的设置以拒绝 Cookies或其他同类技术，或清除软件内保存的所有Cookies或同类技术，或根据相应的选择机制拒绝Cookies或同类技术的应用。但如果您这么做，您可能无法享受最佳的服务体验，如您可能需要在每一次访问小蜜蜂管家端时亲自更改用户设置，而且您之前所记录的相应信息也均会被删除，某些服务也可能无法正常使用。
三、我们如何共享、转让、公开披露您的个人信息
（一）共享
我们不会与小蜜蜂管家端运营者以外的公司、组织和个人共享您的个人信息，但以下情况除外：
...
5、与授权合作伙伴共享：仅为实现本政策中声明的目的，我们可能会与授权合作伙伴共享您的订单信息、账户信息、设备信息、日志信息以及位置信息，以提供更好的客户服务和用户体验。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。我们的授权合作伙伴无权将共享的个人信息用于与小蜜蜂管家端服务无关的其他用途。
目前，我们暂无授权合作伙伴
...
（3）我们对小蜜蜂管家端提供HTTPS（Hyper Text Transfer Protocol over Secure Socket Layer）安全浏览方式。
...
 
（五）安全提示
1、在使用小蜜蜂管家端服务进行沟通或购买商品及服务时，您不可避免地要向交易对方或潜在的交易对方披露自己的个人信息，如联络方式或联系地址。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。
...
3、请您理解，由于技术的限制以及风险防范的局限，即便我们已经尽量加强安全措施，也无法始终保证信息百分之百的安全。您需要了解，您接入小蜜蜂管家端服务所用的系统和通讯网络，有可能因我们可控范围外的情况而发生问题。
 
（六）安全事件处置
...
3、如果您无法通过上述路径访问、更正该等个人信息，您可以通过我们的在线客服与我们取得联系。对于您在使用小蜜蜂管家端服务过程中产生的其他个人信息需要访问或更正，我们会根据本政策所列明的方式、期限及范围来响应您的请求。但出于安全性和身份识别的考虑，您可能无法修改注册时提交的某些初始注册信息。
 
（二）删除您的个人信息
...
（4）如果我们不再为您提供小蜜蜂管家端服务。
若我们确认您的删除请求符合法律法规及其他公示的要求，我们还将同时尽可能通知从我们处获得您的个人信息的关联方及授权合作伙伴，要求其及时删除，除非法律法规另有规定，或这些实体获得您的独立授权。
 
（三）改变您授权同意的范围或撤回您的授权
请您理解，有些基本的个人信息是您使用小蜜蜂管家端服务所必需的，但大多数其他个人信息的提供是由您决定的。您可以通过删除信息、关闭设备功能等方式改变您授权我们继续调用附加功能收集您个人信息的范围或撤回您的授权。当您撤回授权后，我们将无法继续为您提供您撤回授权所对应的服务，也不再处理您相应的个人信息。
 
（四）注销您的账户
您可以登录小蜜蜂管家端移动客户端，通过“我的-设置-账户与安全-注销账户”申请注销您的账户。在您主动注销账户之后，我们将停止为您提供产品或服务，我们将根据适用法律的要求删除您的个人信息，或使其匿名化处理。
 
（五）约束信息系统自动决策
在某些业务功能中，我们可能仅依据信息系统、算法等在内的非人工自动决策机制做出决定。如果这些决定显著影响您的合法权益，您有权要求我们做出解释，我们也将在不侵害小蜜蜂管家端商业秘密或其他用户权益、社会公共利益的前提下提供适当的救济方式。
 
（六）响应您的上述请求
...
8、涉及商业秘密的。
六、第三方服务
小蜜蜂管家端服务可能接入或链接至第三方提供的社交媒体或其他服务（包括网站或其他服务形式）。包括：
1、您可利用“分享”键将小蜜蜂管家端上的某些内容分享给第三方产品，或您可利用第三方服务登录小蜜蜂管家端服务。这些功能可能会收集您的信息（包括您的日志信息），并可能在您的设备内装置Cookies，从而正常运行上述功能；
2、我们通过广告或我们服务的其他方式向您提供链接，使您可以链接至第三方的服务或网站；
3、我们可能会接入第三方SDK或其他类似的应用程序服务（如以嵌入代码、插件等形式），您在小蜜蜂管家端使用这类由第三方提供的服务时，该第三方可能会收集和处理您的部分信息。目前我们接入的第三方SDK或其他类似应用程序服务及相应的信息收集情况主要有：
（1）各类手机厂商的Push SDK可能会收集您的设备信息，用于推送/下发通知栏消息；
（2）高德地图SDK可能会在您授权后收集您的设备位置信息，用于预测产品的配送时限；
（3）运营商SDK可能会收集您的设备信息和手机号，用于快速便捷登录小蜜蜂管家端；
...
七、未成年人信息的保护
小蜜蜂管家端服务主要面向具有完全民事行为能力的成年人。未经父母或者监护人同意，未满十四周岁的儿童不应创建小蜜蜂管家端账户或者使用小蜜蜂管家端服务。如您为未成年人，我们要求您请您的父母或其他监护人仔细阅读本政策及儿童个人信息收集使用规则，并在征得您的父母或其他监护人同意的前提下使用我们的服务或向我们提供信息。
...
八、通知和修订
（一）为了给您提供更好的服务，我们可能会根据小蜜蜂管家端服务的更新情况及法律法规的相关要求适时修改本政策的条款，该等修改构成本政策的一部分。如该等更新造成您在本政策下权利的实质减少或重大变更（如收集和使用的个人信息类型、收集和使用方式发生重大变化），我们将在本政策生效前通过网站公告、推送通知、弹窗提示或其他方式来通知您，您如果不同意该等变更，可以选择停止使用小蜜蜂管家端服务；如您仍然继续使用小蜜蜂管家端服务的，即表示您已充分阅读、理解并同意受经修订的本政策的约束。
我们的任何修改都会将您的满意度置于首位。我们鼓励您在每次使用小蜜蜂管家端服务时都查阅我们的隐私政策。
 
（二）我们可能在必需时（例如当我们由于系统维护而暂停某一项服务时）发出与服务有关的公告。您可能无法取消这些与服务有关、性质不属于推广的公告。
九、如何联系我们
我们设立了个人信息保护专职部门，将按照本政策保护您的个人信息。如您有关于网络信息安全的投诉和举报，或您对本政策、小蜜蜂管家端的隐私措施、您的信息的相关事宜有任何问题、意见或建议，请与小蜜蜂管家端的个人信息保护工作人员联系，可发送邮件至kaidalai@163.com或写信至以下地址：深圳市龙岗区横岗街道沙荷路40-11号
...
 
附件一：儿童个人信息收集使用规则
我们一直非常注重对未成年人的保护，致力于践行我们的企业社会责任。本《儿童个人信息收集使用规则》（以下也称“本规则”）旨在更详细的向监护人（以下也称“您”）和儿童（专指未满十四周岁的未成年人，下同）说明我们如何收集、使用、存储和处理儿童个人信息，以及我们为您与儿童提供的访问、更正、删除、保护这些信息的方式。请您仔细阅读、充分理解并决定选择是否同意本规则以及是否同意您监护的儿童使用小蜜蜂管家端服务。
 
一、适用范围
本规则为《小蜜蜂管家端隐私政策》的一部分；如在儿童个人信息收集和使用规则方面，本规则与《小蜜蜂管家端隐私政策》正文存在不一致的，本规则优先适用，如本规则中未提及的，则适用《小蜜蜂管家端隐私政策》。
 
二、我们收集和使用儿童个人信息的规则
...
2、当我们识别出用户为儿童时，我们可能会收集监护人的联系方式（例如手机号码、电子邮箱），联系监护人以验证其与儿童的监护关系，并在征得监护人同意后允许儿童使用小蜜蜂管家端服务。在此过程中，为了更好地保护儿童的权益，我们还可能向监护人收集更多信息（例如姓名、身份证、户口本或其他监护关系证明），以便进一步验证监护人与儿童的监护关系。
3、我们还可能收集由您或者其他用户主动上传的儿童个人信息，如在使用评价、晒单等功能分享商品相关信息时上传含有儿童个人信息的图片、视频或文字，我们会提示相关用户谨慎选择分享的信息内容，您作为监护人亦应当正确履行监护职责，保护儿童个人信息安全。
4、在儿童使用小蜜蜂管家端服务过程中，我们可能还会收集和使用其他儿童个人信息，具体请查阅《小蜜蜂管家端隐私政策》“我们如何收集和使用个人信息”章节进行详细了解。如我们需要超出上述范围收集和使用儿童个人信息，我们将再次征得监护人的同意。
5、有关儿童个人敏感信息的提示
...
对于儿童个人信息，我们仅在《小蜜蜂管家端隐私政策》所述的目的和范围内或依照法律要求进行共享，并遵循正当必要、知情同意、目的明确、安全保障、依法利用的原则转让、公开披露儿童个人信息，您可以查阅《小蜜蜂管家端隐私政策》“我们如何共享、转让、公开披露您的个人信息”章节了解更多细节。
 
四、您及/或儿童对儿童个人信息的管理规则
(一) 查询和访问儿童个人信息
您或儿童可以在小蜜蜂管家端PC端“个人中心”及App端“个人”页面查询和访问儿童的相关个人信息，例如：账户信息、地址管理。
 
(二) 更正/修改儿童个人信息
您可以在小蜜蜂管家端PC端“个人中心”及App端“个人”页面更正/修改儿童的相关个人信息，或您可以联系我们解决，我们会在经对您的身份进行验证，且不影响信息的客观性和准确性的情况下进行更正/修改。但出于安全性和身份识别的考虑，您可能无法修改注册时提交的某些初始注册信息。
...
我们采用了符合行业标准的安全技术措施及配套的管理体系等多层面保护措施来保护儿童个人信息；同时，我们遵循最小授权原则，对工作人员设定了严格的信息访问权限，控制儿童个人信息知悉范围；我们也采取了必要技术措施，避免违法复制、下载儿童个人信息。如您希望了解更多，请您查阅《小蜜蜂管家端隐私政策》“我们如何保护您的个人信息安全”章节。
 
六、如何联系我们
...
 
附件二：第三方SDK类服务商目录
为保障小蜜蜂管家端服务的相关功能的实现与应用安全稳定的运行，我们可能会接入由第三方提供的软件开发包（SDK）或类似应用程序实现相关目的。我们会对合作方获取信息的软件工具开发包（SDK）或类似应用程序进行严格的安全评估，以保护您的个人信息安全。以下是我们接入的主要的第三方服务商的信息：
 
小米推送SDK
使用目的：推送消息
数据类型：设备标识信息
...
 
微信SDK
使用目的：用于微信账号登录小蜜蜂管家端服务、帮助用户分享内容至微信客户端
数据类型：设备标识信息
官网链接：https://open.weixin.qq.com/
  
QQ SDK
使用目的：用于QQ账号小蜜蜂管家端服务、帮助用户分享内容至QQ客户端
数据类型：设备标识信息
