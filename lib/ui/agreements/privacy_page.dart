      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Text(
              '''
小蜜蜂智慧小区管家端APP是由深圳市凯达来科技有限公司提供的一款智慧小区APP，为用户提供更好、更优、更个性化的服务是我们坚持不懈的追求，也希望通过我们提供的服务可以更方便您的生活。依据法律的规定，我们将在特定情形下收集、使用、保存和披露您的个人信息。以下条款描述了我们如何收集、使用、保存和披露您的个人信息。
