...
二、关于本服务
2.1本服务内容
本服务内容是指凯达来向用户提供的跨平台的生活助手（“小蜜蜂管家端”APP软件），同时提供由物业提供的基础服务、增值物业服务，周边商圈优惠信息，在线支付，政府提供的公共资源等服务内容。

2.2本服务形式
2.2.1 您使用本服务需要下载小蜜蜂管家端软件，对于这些软件，凯达来给予您一项个人的、不可转让及非排他性的许可。

2.2.2 本服务中小蜜蜂管家端软件提供包括但不限于iOS、android等多个应用版本，用户必须选择与所安装手机相匹配的软件版本。
...
七、主权利义务条款
7.1 账号使用规范
7.1.1 您在使用本服务前需要注册一个唯一的小蜜蜂管家端账号。注册账号时请按照软件的提示进行注册，为使填写的信息能尽快被核实通过，请填写您真实的个人及住址信息。

7.1.2 小蜜蜂管家端账号的所有权归凯达来所有，用户完成申请注册手续后，仅获得小蜜蜂管家端账号的使用权，且该使用权仅属于初始申请注册人，同时，初始申请注册人不得赠与、借用、租用、转让或售卖小蜜蜂管家端账号或者以其他方式许可非初始申请注册人使用小蜜蜂管家端账号。非初始申请注册人不得通过受赠、继承、承租、受让或者其他任何方式使用小蜜蜂管家端账号。
...
7.2.3.5 由于无线网络信号不稳定、无线网络带宽小等原因，所引起的小蜜蜂管家端登录失败、资料同步不完整、页面打开速度慢等风险。
...
八、用户行为规范
8.1 信息内容规范
8.1.1 您理解并同意，凯达来一直致力于为用户提供文明健康、规范有序的网络环境，您不得利用小蜜蜂管家端账号或许可软件及服务制作、复制、发布、传播如下干扰许可软件正常运营，以及侵犯其他用户或第三方合法权益的内容，包括但不限于：
...
8.2.6 通过非凯达来开发、授权的第三方软件、插件、外挂、系统，登录或使用小蜜蜂管家端软件及服务，或制作、发布、传播上述工具；
...
8.3.5 未经凯达来书面许可利用小蜜蜂管家端账号和任何功能，以及第三方运营平台进行推广或互相推广的；

8.3.6 利用小蜜蜂管家端账号或许可软件及服务从事任何违法犯罪活动的；
...
10.2 您不得制作、发布、使用、传播用于窃取小蜜蜂管家端账号及他人个人信息、财产的恶意程序。
...
十二、账号注销
12.1您可以通过以下方式注销您的账号： 登入小蜜蜂管家端APP，通过“我的-设置-账号管理-注销账号”来注销账号。在您注销账号前，请确保你在小蜜蜂管家端APP的账号同时满足以下条件，否则你注销账号的申请可能会被拒绝： （1）账户在小蜜蜂管家端APP中无资产、无欠款； （2）账户内无未完成的订单、已提供服务单未支付的订单/服务； 在您主动注销账户之后，我们将停止为您提供产品或服务，我们将删除您的个人信息，使其保持不可被检索、访问的状态，或对使其进行匿名化处理。
