  ...
  Widget build(BuildContext context) {
    return AkuScaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Text(
          '''
欢迎您使用“小蜜蜂智慧小区管家端”APP软件及服务！
为使用“小蜜蜂智慧小区管家端”APP软件（以下简称“许可软件”）及服务，您应当阅读并遵守《服务协议》（以下简称“本协议”）。请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制责任的条款，以及开通或使用某项服务的单独协议，并选择接受或不接受。限制、免责条款可能以加粗形式提示您注意。
...
7.1.2 小蜜蜂智慧小区账号的所有权归凯达来所有，用户完成申请注册手续后，仅获得小蜜蜂智慧小区账号的使用权，且该使用权仅属于初始申请注册人，同时，初始申请注册人不得赠与、借用、租用、转让或售卖小蜜蜂智慧小区账号或者以其他方式许可非初始申请注册人使用小蜜蜂智慧小区账号。非初始申请注册人不得通过受赠、继承、承租、受让或者其他任何方式使用小蜜蜂智慧小区账号。
